...
class Reloader{
    constructor(SystemJs, socketUrl, debounceMs, stateStore){
        this.system = SystemJs;
        // Keep statestore for unload calls
        this._stateStore = stateStore === undefined ? new StateStore() : stateStore;
        // Create systemjs wrapper to hook extra logic needed for reloads
        this._wrapper = new Wrapper(SystemJs, stateStore);
