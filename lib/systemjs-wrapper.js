...
class SystemJsWrapper{
    constructor(SystemJs, stateStore){
        ...
        this._initialLoads = this._system.loads || {};
    }
    ...
    get moduleEntries(){
        ...
        for (var key in this._system.loads){
            if (Object.keys(this._initialLoads).indexOf(key) === -1 && !(exportsFromEntry(this._system.loads[key]).default.prototype instanceof StateStore))
